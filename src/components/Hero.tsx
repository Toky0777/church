...
export function Hero({
  ...
  return (
    <section className="relative flex min-h-[88svh] items-end overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-content px-6 pb-5 sm:pb-16 pt-32 text-bone">
        ...
        <p className="hidden sm:block mt-10 text-sm text-bone/70">Madagascar · International</p>
      </div>
    </section>
  );
}
